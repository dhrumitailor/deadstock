...
export default function SuccessPage() {
    return (
        <div className="max-w-xl mx-auto px-6 py-32 min-h-screen text-white bg-black flex flex-col items-center justify-center text-center">
            
            {/* 1. MINIMAL SUCCESS ICON */}
            <div className="mb-8">
                <CheckCircle size={64} strokeWidth={1} className="text-zinc-100" />
            </div>
            ...
            <div className="mb-12">
                ...
                <p className="text-zinc-500 text-sm leading-relaxed max-w-xs mx-auto">
                    Thank you for your purchase. We are processing your items and will notify you once they are ready for shipment.
                </p>
            </div>
            ...
            <div className="flex flex-col gap-4 w-full max-w-xs">
                <Link
                    href="/profile/orders"
                    className="bg-white text-black py-4 rounded-full font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-zinc-200 transition-all"
                >
                    View My Orders
                </Link>
                ...
                <Link
                    href="/shop"
                    className="border border-zinc-800 text-zinc-400 py-4 rounded-full font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:text-white hover:border-white transition-all"
                >
                    Continue Shopping
                </Link>
            </div>
            ...
            {/* 4. SUBTLE FOOTER */}
            <div className="mt-20 pt-8 border-t border-zinc-900 w-full opacity-50">
                <p className="text-zinc-600 text-[9px] font-bold uppercase tracking-[0.3em]">
                    Need assistance? <Link href="/contact" className="text-zinc-400 underline underline-offset-4 hover:text-white">Contact Support</Link>
                </p>
            </div>
        </div>
    );
